...
export const profile: Profile = {
  ...
  bio: "Full-Stack Developer with 8+ years building products end to end — React and Next.js on the front end, Node.js/Express and Python (Django REST Framework, FastAPI) on the back end. I design and consume RESTful APIs and own UI, structure, and data handling. Currently building AI-powered commercial building automation at Monaire.",
